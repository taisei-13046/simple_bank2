...
// Source: github.com/taisei-13046/simple_bank2/worker (interfaces: TaskDistributor)
...
import (
	...
	worker "github.com/taisei-13046/simple_bank2/worker"
)
...
func (m *MockTaskDistributor) DistributeTaskSendVerifyEmail(arg0 context.Context, arg1 *worker.PayloadendVerifyEmail, arg2 ...asynq.Option) error {
	m.ctrl.T.Helper()
